            ...
            let urls = await page.evaluate(() => {
                ...
                if (comment_thread.length >= 1) {
                    ...
                    comment_thread.forEach((citem) => {
                        ...
                        let author = citem.querySelector('#comment > #body > #main > #header > #header-author > h3 > a > span');
                        ...
                        if (f_haschild) {
                            ...
                            childreply.forEach((childitem) => {
                                ...
                                f_ci_author = ci_author.innerText;
...
function logJSON(urls) {
    console.log(urls);
    fs.writeFile('myJSONfile.json', JSON.stringify(urls[0]),'utf8', function(err) {
        console.log(err);
        throw err;
    });
}
